...
#define AI_FLAG_DOUBLES_TRIGGER_SETUP       (1 << 25)  // On turn 1 in doubles, intentionally uses moves that trigger ally passive abilities/items (Weakness Policy, Anger Point, Justified, Guts, Storm Drain, etc.).
...
// Smart trainer preset for doubles; includes ally-trigger synergy scoring on top of the full smart trainer suite.
#define AI_FLAG_SMART_DOUBLES_TRAINER (AI_FLAG_SMART_TRAINER | AI_FLAG_DOUBLES_TRIGGER_SETUP)
